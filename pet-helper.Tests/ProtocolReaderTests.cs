...
public sealed class ProtocolReaderTests
{
    ...
    {
        var message = ProtocolReader.Parse("{\"version\":17,\"kind\":\"shutdown\"}");
    ...
    {
        var message = ProtocolReader.Parse("{\"version\":17,\"kind\":\"state\",\"state\":\"active\",\"activities\":[\"thinking\",\"working\"],\"label\":\"思考中/工作中\",\"sequence\":4}");
    ...
    {
        var message = ProtocolReader.Parse("{\"version\":17,\"kind\":\"state\",\"state\":\"active\",\"activities\":[\"responding\"],\"label\":\"输出中…\",\"sequence\":4}");
    ...
    {
        var message = ProtocolReader.Parse("{\"version\":17,\"kind\":\"state\",\"state\":\"question\",\"activities\":[],\"label\":\"点击回到 Harness 回答\",\"sequence\":4}");
    ...
    {
        var message = ProtocolReader.Parse("{\"version\":17,\"kind\":\"state\",\"state\":\"active\",\"activities\":[\"thinking\"],\"label\":\"思考中…\",\"sequence\":4}");
    ...
    {
        var message = ProtocolReader.Parse("{\"version\":17,\"kind\":\"state\",\"state\":\"active\",\"activities\":[\"thinking\"],\"label\":\"思考中…\",\"sequence\":9007199254740991}");
    ...
    {
        var message = ProtocolReader.Parse("{\"version\":17,\"kind\":\"config\",\"scale\":1.25,\"reducedMotion\":true,\"physicsEnabled\":true,\"physicsBouncePercent\":50,\"petPlacement\":\"top-center\",\"dialoguePlacement\":\"middle-right\",\"dialogueWidth\":320,\"dialogueHeight\":420,\"dialogueFontSize\":16,\"randomChatEnabled\":false,\"randomChatBrowseOnOpen\":false,\"randomChatConfigured\":false,\"randomChatMinIntervalMinutes\":8,\"randomChatMaxIntervalMinutes\":24,\"randomChatCustomPrompts\":[\"和我聊聊？\"]}");
    ...
    {
        var request = ProtocolReader.Parse("{\"version\":17,\"kind\":\"approval-request\",\"requestId\":7}");
        var resolved = ProtocolReader.Parse("{\"version\":17,\"kind\":\"approval-resolved\",\"requestId\":7,\"outcome\":\"allowed-once\"}");
    ...
    {
        Assert.Null(ProtocolReader.Parse("{\"version\":17,\"kind\":\"approval-request\",\"requestId\":7,\"reason\":\"C:\\\\secret\"}"));
        Assert.Null(ProtocolReader.Parse("{\"version\":17,\"kind\":\"approval-resolved\",\"requestId\":7,\"outcome\":\"always\"}"));
    }

    [Fact]
    public void Parses_v7_config_with_default_layout()
    {
        var message = ProtocolReader.Parse("{\"version\":17,\"kind\":\"config\",\"scale\":1.25,\"reducedMotion\":true,\"physicsEnabled\":true,\"physicsBouncePercent\":50,\"petPlacement\":\"bottom-right\",\"dialoguePlacement\":\"near-pet\",\"dialogueWidth\":320,\"dialogueHeight\":420,\"dialogueFontSize\":14,\"randomChatEnabled\":false,\"randomChatBrowseOnOpen\":false,\"randomChatConfigured\":false,\"randomChatMinIntervalMinutes\":8,\"randomChatMaxIntervalMinutes\":24,\"randomChatCustomPrompts\":[]}");
    ...
    {
        Assert.Null(ProtocolReader.Parse("{\"version\":17,\"kind\":\"config\",\"scale\":1,\"reducedMotion\":false,\"petPlacement\":\"center\",\"dialoguePlacement\":\"near-pet\",\"dialogueWidth\":320,\"dialogueHeight\":420,\"randomChatEnabled\":false,\"randomChatBrowseOnOpen\":false,\"randomChatConfigured\":false,\"randomChatMinIntervalMinutes\":8,\"randomChatMaxIntervalMinutes\":24,\"randomChatCustomPrompts\":[]}"));
        Assert.Null(ProtocolReader.Parse("{\"version\":17,\"kind\":\"config\",\"scale\":1,\"reducedMotion\":false,\"physicsEnabled\":true,\"physicsBouncePercent\":101,\"petPlacement\":\"center\",\"dialoguePlacement\":\"near-pet\",\"dialogueWidth\":320,\"dialogueHeight\":420,\"randomChatEnabled\":false,\"randomChatBrowseOnOpen\":false,\"randomChatConfigured\":false,\"randomChatMinIntervalMinutes\":8,\"randomChatMaxIntervalMinutes\":24,\"randomChatCustomPrompts\":[]}"));
    }
    ...
    {
        var message = ProtocolReader.Parse("{\"version\":17,\"kind\":\"reply-preview\",\"requestId\":7,\"text\":\"abcdef\",\"completed\":false}");
    ...
    public void Parses_an_extended_reply_preview_text()
    {
        ...
        var message = ProtocolReader.Parse($"{{\"version\":17,\"kind\":\"reply-preview\",\"requestId\":7,\"text\":\"{text}\",\"completed\":false}}");

        Assert.Equal(new ReplyPreviewMessage(7, text, false), message);
        Assert.Null(ProtocolReader.Parse($"{{\"version\":17,\"kind\":\"reply-preview\",\"requestId\":7,\"text\":\"{text}a\",\"completed\":false}}"));
    }

    [Theory]
    [InlineData("{\"version\":17,\"kind\":\"conversation-config\",\"previewEnabled\":true,\"previewMaxChars\":80,\"defaultSessionId\":null,\"defaultWorkspaceId\":null}", true, 80)]
    [InlineData("{\"version\":17,\"kind\":\"conversation-config\",\"previewEnabled\":false,\"previewMaxChars\":8000,\"defaultSessionId\":null,\"defaultWorkspaceId\":null}", false, 8000)]
    ...
    {
        var message = ProtocolReader.Parse($"{{\"version\":17,\"kind\":\"input-status\",\"requestId\":7,\"status\":\"{status}\"}}");
    ...
    {
        var message = ProtocolReader.Parse("{\"version\":17,\"kind\":\"clear-preview\",\"requestId\":7,\"reason\":\"next-input\"}");
    ...
    {
        var message = ProtocolReader.Parse("{\"version\":17,\"kind\":\"reply\",\"requestId\":7,\"text\":\"final\",\"completed\":true}");
    ...
    {
        var message = ProtocolReader.Parse("{\"version\":17,\"kind\":\"conversation-history\",\"requestId\":8,\"available\":true,\"messages\":["
    ...
    {
        var line = "{\"version\":17,\"kind\":\"target-request\",\"requestId\":7,"
    ...
    {
        var message = ProtocolReader.Parse("{\"version\":17,\"kind\":\"target-request\",\"requestId\":7,"
